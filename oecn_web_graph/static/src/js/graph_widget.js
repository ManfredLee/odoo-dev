...
openerp.web_graph.Graph = openerp.web.Widget.extend({
    ...
    start: function() {
        ...
        return this.model.call('fields_get', [], {context: this.build_context()}).then(function (f) {
            self.fields = f;
    ...
    build_context: function(){
        var _ctx = this.graph_view.ViewManager.dataset.context;
        return {lang: _ctx.lang, tz: _ctx.tz }
    }
});
